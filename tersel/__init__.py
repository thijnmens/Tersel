...
class Tersel:
	def __init__(self, title: str, options: [any], max_options_shown: int = 5, line_start: str = "[{index}] ", title_color: str = Fore.GREEN, option_color: str = Fore.LIGHTBLACK_EX, selected_color: str = Fore.LIGHTCYAN_EX):
		"""
